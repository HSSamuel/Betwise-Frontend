...
import { FaPlus, FaEdit, FaTrashAlt, FaGift } from "react-icons/fa";
    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold flex items-center">
          <FaGift className="mr-3 text-yellow-500" /> Manage Promotions
        </h1>
        ...
        <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden">
          <table className="min-w-full">
            <thead className="bg-gray-50 dark:bg-gray-700">
              <tr>
                {/* --- Correction: Added dark mode text colors to headers --- */}
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-600">
              {promoData?.promotions.map((promo) => (
                <tr key={promo._id}>
                  {/* --- Correction: Added dark mode text colors to cells --- */}
